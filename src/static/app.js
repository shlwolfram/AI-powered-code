    ...
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsMarkup = participants.length
          ? `<p><strong>Participants:</strong></p><ul class="participants-list">${participants.map((participant) => `<li>${participant}</li>`).join("")}</ul>`
          : `<p><strong>Participants:</strong> <span class="info-text">No participants yet</span></p>`;
